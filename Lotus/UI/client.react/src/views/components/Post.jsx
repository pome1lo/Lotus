                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <button type="button" className="btn red-color btn-outline-secondary btn-sm" onClick={deletePost}>Delete post</button>
                        </div>
                        <div className="modal-footer">
                            <button type="button" className="btn btn-secondary btn-sm"
                                    data-bs-dismiss="modal">Закрыть
                            </button>
                            <button type="button" className="btn btn-danger btn-sm">Сохранить изменения</button>
                        </div>
                    </div>
                </div>
            </div>
