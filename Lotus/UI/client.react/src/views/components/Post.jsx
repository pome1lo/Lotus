...
const Post =  ({ post_id, user_image, username, dop_info, content_image, content_heading, user_id, content_text, isAuthor }) => {
    ...
    async function deletePost() {
        const response = await authFetch(`https://localhost:31903/api/profile/post/${post_id}`, {
            method: 'DELETE'
        });
        if (!response.ok) {
        ...
        <>
            ...
            <div className="modal fade" id="postEditModal" tabIndex="-1" aria-labelledby="postEditModalLabel"
                ...
                <div className="modal-dialog">
                    <form className="modal-content" onSubmit={editPost}>
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="submit" className="btn btn-danger btn-sm">Edit post</button>
                        </div>
                    </form>
                </div>
            </div>
