                    ...
                    <>
                        ...
                        {currentUsername === user.USERNAME ? (
                            <>
                                <div className="d-flex align-items-center w-100 justify-content-between text-muted">
                                    <div className="d-flex">
                                        {user &&
                                            <img src={user.PROFILE_PICTURE} width="30px" className="mr-2 border-radius"
                                                 alt={"content"}/>}
                                ...
                                posts.length > 0 ? (
                                    posts.sort((a, b) => b.ID - a.ID).map(item => (
                                        <Post key={item.ID}
                                              ...
                                              isAuthor={currentUsername === user.USERNAME}
                        ...
                        <div className="modal fade" id="staticBackdrop" data-bs-backdrop="static"
                            ...
                            <div className="modal-dialog">
                                <form className="modal-content" onSubmit={fetchData}>
